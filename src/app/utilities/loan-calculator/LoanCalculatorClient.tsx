...
import { LoanCalculatorConfig } from "@/lib/calculator-config";
...
export default function LoanCalculatorClient({ config }: Props) {
  const [loanAmount, setLoanAmount] = useState<string>("");
  const [interestRate, setInterestRate] = useState<string>(config.default_interest_rate.toString());
