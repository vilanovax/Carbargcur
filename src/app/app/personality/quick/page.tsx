...
export default function PersonalityAssessment() {
  ...
  const handleSaveToProfile = () => {
    ...
    try {
      ...
      profile.personality = {
        ...profile.personality, // Preserve any existing full test results
        quick: {
          ...
          <div className="text-center space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div className="bg-slate-50 p-4 rounded-lg">
                ...
                <div className="text-2xl font-bold text-blue-600">~3 دقیقه</div>
              </div>
            </div>
        ...
        <Card className="max-w-2xl w-full p-8">
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <Button
                variant="outline"
                className="w-full h-auto py-4 px-6 text-right justify-start hover:bg-blue-50 hover:border-blue-300"
              ...
              >
                <div className="flex items-start gap-3 w-full">
                  <div className="w-6 h-6 rounded-full border-2 border-slate-300 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <div className="w-3 h-3 rounded-full bg-blue-600 opacity-0 group-hover:opacity-100"></div>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                {result.styles.map((style) => (
                  <Badge
                    key={style}
                    className="px-4 py-2 bg-blue-100 text-blue-700 text-base"
                  >
            ...
            <div className="space-y-4 pt-4">
              {result.styles.map((style) => {
                ...
                if (!info) return null;
                return (
                  <div key={style} className="border-r-4 border-blue-500 bg-white p-4 rounded">
